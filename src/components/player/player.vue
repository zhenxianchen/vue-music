...
//   mixins: [playerMixin],
  ...
  methods: {
    ...
    _getPosAndScale() {
      const targetWidth = 40 // miniplayer中唱片图的宽度
      const paddingLeft = 40 // miniplayer中唱片图的中心离左边界的宽度
      const paddingBottom = 30 // miniplayer中唱片图的中心离下边界的高度
      const paddingTop = 80 // 大唱片图距离上边界的高度
      const width = window.innerWidth * 0.8 // 大唱片图的宽度
